...
import { faAlgolia, faAngular, faBootstrap, faReact, faSchlix, faVuejs } from "@fortawesome/free-brands-svg-icons";
...
export const CircleChartWidget = (props) => {
  const { title,category, data = [] } = props;
  ...
  return (
    <Card border="light" className="shadow-sm">
      <Card.Header className="border-bottom border-light">
        <h5 className="mb-0">Top Selling Plans</h5>
      </Card.Header>
      <Card.Body>
